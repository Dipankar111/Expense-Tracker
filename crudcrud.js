function saveToLocalStorage(event) {
    ...
    axios.post("https://crudcrud.com/api/62c5bbad505d45da84dcd0f2c5e8ca36/tracker", obj)
                    .then((respone) => {
...
window.addEventListener("DOMContentLoaded", () => {
    axios.get("https://crudcrud.com/api/62c5bbad505d45da84dcd0f2c5e8ca36/tracker")
         .then((response) => {
            //  console.log(response) 
...
function deleteExpense(expenseId){
    axios.delete(`https://crudcrud.com/api/62c5bbad505d45da84dcd0f2c5e8ca36/tracker/${expenseId}`)
        .then((response) => {
